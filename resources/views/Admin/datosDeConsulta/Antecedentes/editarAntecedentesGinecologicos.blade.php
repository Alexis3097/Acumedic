                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="Id" value="{{$anteGinecologico->id}}">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="CaractMenstruacion" id="CaractMenstruacion" class="form-control" placeholder="Características de menstruación" value="{{$anteGinecologico->CaractMenstruacion}}" >
                                </div>
