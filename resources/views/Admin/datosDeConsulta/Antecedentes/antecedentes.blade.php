                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                ...
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <input type="text" class="form-control" name="OtrosPat" id="OtrosPat" placeholder="Otro antecedente patologico">
                                                                </div>
                                                            </div> <!-- end col -->
                                                        </div> <!-- end row -->
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group mt-3 mt-xl-0">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ActividadFisica" id="ActividadFisica" placeholder="Ingrese si el paciente hace alguna actividad física">
                                                                </div> 
                                                                <div class="form-group">
                                                                    <label for="Tabaquismo">Tabaquismo</label>
                                                                    <input type="text" class="form-control" name="Tabaquismo" id="Tabaquismo" placeholder="Ingrese si el paciente consume tabaco">
                                                                </div>                            
                                                                <div class="form-group mb-0">
                                                                    <label for="Alcoholismo">Alcoholismo</label>
                                                                    <input type="text" class="form-control" name="Alcoholismo" id="Alcoholismo"placeholder="Ingrese si el paciente consume alcohol">
                                                                </div>
                                                                <div class="form-group mb-0">
                                                                    <label for="SustanciasODrogas">Uso de sustancias o drogas</label>
                                                                    <input type="text" class="form-control" name="SustanciasODrogas" id="SustanciasODrogas"placeholder="Ingrese si el paciente usa sustancias o drogas">
                                                                </div>
                                                                <div class="form-group mb-0">
                                                                    <label for="VacunasRecientes">Vacunas recientes</label>
                                                                    <input type="text" class="form-control" name="VacunasRecientes" id="VacunasRecientes"placeholder="Ingrese si el paciente usa sustancias o drogas">
                                                                </div>
                                                                <div class="form-group mb-0">
                                                                    <label for="OtrosNoPat">Otros</label>
                                                                    <input type="text" class="form-control" name="OtrosNoPat" id="OtrosNoPat"placeholder="Otro antecedente no patologico">
                                                                </div>
                                                            </div> <!-- end col -->
                                                        </div> <!-- end row -->
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="date" value="{{$fecha}}" name="FechaPrimeraMenstruacion" id="FechaPrimeraMenstruacion">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="FechaUltimaMenstruacion">Fecha de ultima menstruación</label>
                                                                    <input class="form-control" type="date" value="{{$fecha}}" name="FechaUltimaMenstruacion" id="FechaUltimaMenstruacion">
                                                                </div>
                                                                <div class="form-group mb-0">
                                                                    <label for="CaractMenstruacion">Caracteristicas de menstruación</label>
                                                                    <input type="text" name="CaractMenstruacion" id="CaractMenstruacion" class="form-control" placeholder="Caracteristica de menstruación">
                                                                </div>
                                                                <div class="form-group mt-3 mt-xl-0">
                                                                    <label for="Embarazos">Embarazos</label>
                                                                    <input type="text"  name="Embarazos"id="Embarazos" class="form-control" placeholder="Datos sobre embarazos">
                                                                </div> 
                                                                <div class="form-group mt-3 mt-xl-0">
                                                                    <label for="CancerCervico">Cancer cervico</label>
                                                                    <input type="text" name="CancerCervico" id="CancerCervico" class="form-control" placeholder="Datos sobre cancer cervico">
                                                                </div> 
                                                                <div class="form-group mt-3 mt-xl-0">
                                                                    <label for="CancerUterino">Cancer uterino</label>
                                                                    <input type="text" id="CancerUterino" name="CancerUterino" class="form-control" placeholder="Datos sobre cancer uterino">
                                                                </div> 
                                                                <div class="form-group mt-3 mt-xl-0">
                                                                    <label for="OtrosGine">Otros</label>
                                                                    <input type="text" name="OtrosGine" id="OtrosGine" class="form-control" placeholder="Otro antecedente ginecologico">
                                                                </div> 
                                                            </div> <!-- end col -->
                                                        </div> <!-- end row -->
                                                    </div>
