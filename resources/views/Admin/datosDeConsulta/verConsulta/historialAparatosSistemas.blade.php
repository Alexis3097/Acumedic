                            ...
                            <div class="card">
                                ...
                                <div class="media col-xl-2" style="display: inline-flex">
                                    ...
                                    <div class="media col-md-9 button-list" style="display: inline-flex; top:-35px;">
                                            ...
                                            <a href="{{ route('historial.verSintomasSubjetivos',['IdConsulta'=>$aparatosSistemas->IdConsulta]) }}" class="btn btn-info" style="width: 100%;" type="submit">Síntomas subjetivos</a>
                                    </div>
                                </div>
                            </div>
                            </div>
